...
namespace Grupo2_ToppinoMariano_FacundoSafe_FedericoPrado
{
    class Cine
    {
        ...
        public bool loguearse (String mail, String contraseña) // QUIZAS MAS QUE DEVOLVER UN BOOLEAN DEBERIA SETEAR UN BOOLEAN EN EL CLIENTE
        {
            ...
            if (c != null)
            {
                if (c.getPassword().equals(contraseña))//NECESITO UN METODO QUE ME DEJE COMPARAR LA CONTRASEÑA UN GET PASSWORD EN CLIENTE
                {
                    pudoLoguear = true;
            ...
            {
                throw new ArgumentException("***el Mail no se encuentra Registrado***");
            }
